...
import com.playdata.springbootproject.web.dto.HikersResponseDto;
...
//    public String signUp(HikersSaveRequestDto requestDto) {
//        hikersService.save(requestDto);
//        return "/login"; //로그인 구현 예정
//    }
    ...
    public String save(@RequestBody HikersSaveRequestDto requestDto) {
